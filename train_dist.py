...
parser.add_argument('--omp_num_threads', type=int, default=4)
...
sys.stdout = Logger(osp.join('./log/', args.model_name + formatted_time+'.txt'))
set_seed(args.seed)
torch.distributed.init_process_group(backend='nccl', timeout=datetime.timedelta(0, 3600))
